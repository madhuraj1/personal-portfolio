...
export const Contact = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Contact Us - Celebration Chapters</title>
        <meta property="og:title" content="Contact Us - Celebration Chapters" />
        <meta
          property="og:description"
          content="Have questions? Contact Celebration Chapters for inquiries about our photo and film services."
        />
        <meta
          property="og:url"
          content="https://www.celebrationchapters.com/contact"
        />
        <meta
          property="og:image"
        ...
        <meta
          ...
          content="Get in touch with Celebration Chapters"
        />
        <meta
          property="twitter:title"
          content="Contact Us - Celebration Chapters"
        />
        <meta
          property="twitter:description"
          content="Reach out for inquiries about our photography and filmmaking services."
        />
        <meta
